"""Build the feature tables once; main.py reuses them for training and evaluation.
...
from prepdata.feature_table import NON_COMMERCIAL_ELEMENTS, RARE_EARTH_ELEMENTS, build_feature_table
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--novamag-dir", default="./data/novamag/Novamag_Data_Files/",
